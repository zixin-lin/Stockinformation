  ...
  return (
   <div>
		...
		<ul className={styles.daohang}>
			<li className={styles.logo}><Image src="/logo.jpg" alt="Picture of the author"/></li>
      ...
      <li className={styles.line}><Link href = "/Performance"><a>Market Performance</a></Link></li>
			...
			<li className={styles.Contact}>
				...
				<span className="desc">Email:12345678901@126.com.cn</span>
				<span className="desc">Phone:12345678901</span>
			</li>
		</ul>
